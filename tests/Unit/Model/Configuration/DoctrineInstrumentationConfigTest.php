...
use Danilovl\OpenTelemetryBundle\Model\Configuration\DoctrineInstrumentationConfig;
use Generator;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

/** @phpstan-import-type DoctrineInstrumentationConfigArray from DoctrineInstrumentationConfig */
class DoctrineInstrumentationConfigTest extends TestCase
{
    /**
     * @phpstan-param DoctrineInstrumentationConfigArray $config
     */
    ...
    public function testFromConfig(
        ...
        $result = DoctrineInstrumentationConfig::fromConfig($config);
